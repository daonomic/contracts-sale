...
contract SimpleWhitelistSale is WhitelistImpl, WhitelistSale, MintingSale {

    constructor(ERC20Mintable _token, uint _referrerBonus, uint _refereeBonus) MintingSale(_token) public {
